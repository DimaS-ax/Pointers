...
void main()
{
	setlocale(LC_ALL, "ru");
	int n;
	cout << "¬видите размер массива: "; cin >> n;
	int* arr = new int[n];
	FillRand(arr, n);
	Print(arr, n);
	push_front(arr, n);
	Print(arr, n);
	int var;
	cout << "¬видите значение элемента: "; cin >> var;
	int index;
	cout << "¬видите индекс массива: "; cin >> index;
	...
	pop_front(arr, n);
	Print(arr, n);
	cout << "”кажите индекс удал€емого элемента: "; cin >> index;
	erase(arr, n, index);
	Print(arr, n);
